...
import { ArrowLeftIcon, BanknotesIcon, CheckCircleIcon, DocumentArrowDownIcon, EyeIcon, PlusIcon } from '@heroicons/vue/24/outline'
  ...
  <div class="space-y-6">
    ...
    <div class="flex items-center justify-between">
      <div class="flex items-center space-x-4">
        <button class="p-2 hover:bg-gray-100 rounded-lg" @click="router.push('/service-providers')">
      ...
      <div v-if="provider" class="flex space-x-3">
        <button
    ...
    <div v-if="showPaymentModal" class="fixed inset-0 z-50 overflow-y-auto">
      <div class="flex items-center justify-center min-h-screen px-4">
        ...
        <div class="relative bg-white rounded-lg shadow-xl max-w-lg w-full p-6">
          ...
          <form class="space-y-4" @submit.prevent="createPayment">
            ...
            <div class="flex justify-end space-x-3 pt-4">
              <button type="button" class="px-4 py-2 text-gray-700 hover:text-gray-900" @click="showPaymentModal = false">Cancel</button>
