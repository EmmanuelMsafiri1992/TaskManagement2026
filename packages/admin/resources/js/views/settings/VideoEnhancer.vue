    ...
    <Card>
      <template #header>
        <div class="flex items-center justify-between">
          <h2 class="text-lg font-medium text-gray-900">Video Enhancer</h2>
          <span class="text-sm text-gray-500">Max file size: 2GB</span>
        </div>
      </template>
...
const loadVideos = () => {
  axios.get('/api/video-enhancer').then((response: any) => {
    ...
    // Set current video if there's one pending or processing
