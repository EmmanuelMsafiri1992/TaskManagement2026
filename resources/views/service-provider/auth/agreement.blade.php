            ...
            <form method="POST" action="{{ route('service-provider.agreement') }}" class="p-8">
                ...
                <div class="mb-4 p-4 bg-amber-50 border border-amber-200 rounded-lg">
                    <div class="flex items-start">
                        ...
                        <div>
                            <h4 class="text-sm font-semibold text-amber-800">Important Commitment</h4>
                            <p class="text-sm text-amber-700 mt-1">
                                By signing this agreement, you are committing to <strong>complete the entire syllabus</strong> for each subject assigned to you.
                                This means recording all topics and lessons required to cover the full curriculum - no partial completion.
                            </p>
                        </div>
                    </div>
                </div>
                ...
                <div class="mb-6">
                    <label class="flex items-start">
                        ...
                        <span class="ml-3 text-sm text-gray-700">
                            ...
                            <strong class="text-gray-900">I commit to completing the entire syllabus for each subject assigned to me, covering all topics and lessons in full.</strong>
                        </span>
                    </label>
                </div>
