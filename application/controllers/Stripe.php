...
class Stripe extends Home_Controller {
	...
	public function __construct(){
		parent::__construct();
		// Set your Stripe secret key from environment or config
		$this->stripe_secret_key = getenv('STRIPE_SECRET_KEY') ?: $this->config->item('stripe_secret_key');
	}
	...
	public function payment__()
	{
		...
		if($insert):
			...
			$this->email_m->send_payment_paid_email($data,'Credit Card');
